...
<head>
    ...
    <title>CFTV Gentil Bittencourt - Acompanhar Status do Atendimento</title>
...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow py-8 px-4 sm:px-6">
        <div class="acompanhamento-container p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-7xl mx-auto">
            <h2 class="text-xl sm:text-2xl font-semibold text-blue-900 text-center mb-6">Acompanhar Status do Atendimento</h2>
            <nav class="mb-6">
                <ul class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 justify-center">
                    <li><a href="solicitacao.php" class="nav-button">Abrir Novo</a></li>
                    <li><a href="acompanhar_status.php" class="nav-button active">Acompanhar Status</a></li>
                </ul>
            </nav>
